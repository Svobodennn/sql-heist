...
// The Cowled — SQL Heist's mark: a hooded figure with its face lost in shadow, the
// anonymous operative who walks through the door nobody locked. `currentColor` lets it
// inherit the surrounding ink (brass in the nav/footer wordmark).
// Mark: "cowled" from game-icons.net — CC BY 3.0 (see README credits).
